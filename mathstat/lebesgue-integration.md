...
(2) measurable set [2, pp. 25]

A measurable set is the $\sigma$-alegbra, $\mathcal{M}$, in a measurable space:
$$ \mathcal{M} \in (X,\mathcal{M}) $$
