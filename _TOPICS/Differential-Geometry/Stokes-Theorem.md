...
An equation that relates a definite integral of a derivative over a domain to a definite integral on the edge of that domain is used to move a definite integral from a domain onto its edge.
