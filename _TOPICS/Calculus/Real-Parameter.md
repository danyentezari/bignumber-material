...
1. do Carmo, M. P. *Differential Geometry of Curves and Surfaces*. — parametrized differentiable curve $\boldsymbol{\alpha}: I \to \mathbb{R}^{3}$; “The variable $t$ is called the parameter of the curve.”
