...
6\. A single molecule does not decompose on its own; it must first gain vibrational energy in a collision. An energized molecule has that energy but has not yet broken the bond. At low pressure a later collision can remove the energy before the bond breaks. This principle is used to explain how gas-phase unimolecular rates depend on pressure.

Note: These principles are elementary reactions and molecularity, the Arrhenius activation barrier, transition-state theory, the rate-determining-step approximation, the steady-state approximation, and the Lindemann-Hinshelwood mechanism of unimolecular reactions.

## References

1. Levine, I. N. *Physical Chemistry*. Ch. 16 §16.5 — elementary reactions. §16.6 — rate-determining step and steady state. §16.8 — activation energy. §16.11 — unimolecular reactions. Ch. 22 §22.4 — transition-state theory.
2. Atkins, P., de Paula, J., & Keeler, J. *Atkins’ Physical Chemistry*. Topic 17D — activation. Topic 17E — mechanisms. Topic 17F — unimolecular reactions. Topic 18C — transition-state theory.
