...
- $\Phi_{B}$ is the magnetic flux through the circuit.
...
- $\Phi_{21}$ is the flux through circuit 2 due to circuit 1.
...
1. Griffiths, D. J. *Introduction to Electrodynamics*. Cambridge University Press, 2024. §7.2.3–7.2.4 — inductance and magnetic energy.
