...
$$
\mathbf{B} = \dfrac{\mu_{0}}{4\pi}\dfrac{q\mathbf{v}\times\hat{\mathbf{r}}}{r^{2}}
$$
...
- $\hat{\mathbf{r}}$ is the unit vector from the charge to the field point.
...
1. Griffiths, D. J. *Introduction to Electrodynamics*. Cambridge University Press, 2024. §5.1–5.2 — moving charges as current and as sources of $\mathbf{B}$.
2. Knight, R. D. *Physics for Scientists and Engineers: A Strategic Approach with Modern Physics*. Pearson, 2023. — charge motion as current.
