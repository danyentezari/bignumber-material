...
1\. The transmitted ray bends according to Snell's law. This principle is used to compute the angle of refraction from the two indices.
...
2\. The wave speed in a linear medium is $c/n$. This principle is used to relate the index to the permittivity and permeability of the medium.
...
3\. When $n_{1} > n_{2}$ and the incidence angle exceeds the critical angle, there is no transmitted ray. This principle is used to describe total internal reflection.
...
Note: These principles are Snell's law, the index of refraction, and total internal reflection.

## References

1. Griffiths, D. J. *Introduction to Electrodynamics*. Cambridge University Press, 2024. §9.3–9.4 — refraction and total internal reflection.
