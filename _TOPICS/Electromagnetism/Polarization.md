...
$$
\mathbf{E}(z,t) = E_{0}\cos(kz-\omega t)\,\hat{\mathbf{x}}
$$

where

- $\mathbf{E}$ is the electric field.
- $E_{0}$ is the amplitude.
...
$$
\mathbf{E}(z,t) = E_{0}\bigl[\cos(kz-\omega t)\,\hat{\mathbf{x}} \pm \sin(kz-\omega t)\,\hat{\mathbf{y}}\bigr]
$$
...
1. Griffiths, D. J. *Introduction to Electrodynamics*. Cambridge University Press, 2024. §9.2 — polarization of electromagnetic waves.
2. Knight, R. D. *Physics for Scientists and Engineers: A Strategic Approach with Modern Physics*. Pearson, 2023. — polarization of light.
