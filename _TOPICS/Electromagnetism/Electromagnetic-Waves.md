...
$$
\nabla^{2}\mathbf{E} = \mu_{0}\epsilon_{0}\dfrac{\partial^{2}\mathbf{E}}{\partial t^{2}}
$$

$$
\nabla^{2}\mathbf{B} = \mu_{0}\epsilon_{0}\dfrac{\partial^{2}\mathbf{B}}{\partial t^{2}}
$$
...
The plane-wave field coupling is

$$
\mathbf{B} = \dfrac{1}{c}\bigl(\hat{\mathbf{k}}\times\mathbf{E}\bigr)
$$

where

- $\hat{\mathbf{k}}$ is the unit vector in the direction of travel.
- $\mathbf{E}$ is the electric field.
- $\mathbf{B}$ is the magnetic field.
- $c$ is the speed of light in vacuum.
...
$$
u = \dfrac{1}{2}\Bigl(\epsilon_{0}E^{2} + \dfrac{1}{\mu_{0}}B^{2}\Bigr) = \epsilon_{0}E^{2}
$$

The time-averaged energy density is

$$
\langle u\rangle = \dfrac{1}{2}\epsilon_{0}E_{0}^{2}
$$

where

- $u$ is the energy density.
- $\langle u\rangle$ is the time-averaged energy density.
...
$$
\mathbf{S} = \dfrac{1}{\mu_{0}}\bigl(\mathbf{E}\times\mathbf{B}\bigr)
$$

The wave intensity is

$$
I = \langle S\rangle = \dfrac{1}{2}c\epsilon_{0}E_{0}^{2}
$$
...
- $I$ is the intensity.
- $\langle S\rangle$ is the time average of the magnitude of $\mathbf{S}$.
- $\mathbf{E}$ is the electric field.
- $\mathbf{B}$ is the magnetic field.
- $\mu_{0}$ is the permeability of free space.
- $c$ is the speed of light in vacuum.
...
$$
\mathbf{g} = \epsilon_{0}\bigl(\mathbf{E}\times\mathbf{B}\bigr) = \dfrac{1}{c^{2}}\mathbf{S}
$$

The radiation pressure on a perfect absorber at normal incidence is

$$
P_{\mathrm{rad}} = \dfrac{I}{c}
$$
...
1. Griffiths, D. J. *Introduction to Electrodynamics*. Cambridge University Press, 2024. §9.2.1–9.2.3 — wave equation, speed of light, transversality, energy density, Poynting vector, intensity, and radiation pressure.
