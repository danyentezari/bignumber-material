...
1. Knight, R. D. *Physics for Scientists and Engineers: A Strategic Approach with Modern Physics*. Pearson, 2023. §1.5 — position locates an object with respect to a chosen coordinate system.
2. Kreyszig, E. *Advanced Engineering Mathematics*. 10th ed. Wiley, 2011. §9.1 — position vector of a point $(x,y,z)$ from the origin.
3. Waleffe, F. *Vector and Complex Calculus*. Oxford University Press, 2025. §7.1 — position vector as the displacement from a reference point $O$ to $P$.
