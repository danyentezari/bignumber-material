...
1. [Space](space.html)
2. [Time](time.html)
3. [Position](position.html)
4. [Velocity](velocity.html)
...
1. Shankar, R. *Fundamentals of Physics I*. Yale University Press, 2019. Ch. 3, 5, 8, 13 — motion of objects in space and time.
2. Knight, R. D. *Physics for Scientists and Engineers: A Strategic Approach with Modern Physics*. Pearson, 2023. Ch. 5, 7, 10–12 — position, distance, and the timing of events.
3. Feynman, R. P., Leighton, R. B., & Sands, M. *The Feynman Lectures on Physics*, Vol. I. Ch. 9, 10, 12, 20 — Newtonian motion when speeds are small compared with light.
4. Schwichtenberg, J. *Physics from Symmetry*. Springer, 2018. §4.1 — classical mechanics as the large-action limit.
