...
$$
\mathbf{a}_{\mathrm{avg}} = \dfrac{\Delta\mathbf{v}}{\Delta t}
$$

where

- $\mathbf{a}_{\mathrm{avg}}$ is the average acceleration.
...
$$
\mathbf{a} = \lim_{\Delta t \to 0}\dfrac{\Delta\mathbf{v}}{\Delta t}
$$

where

- $\mathbf{a}$ is the instantaneous acceleration.
- $\Delta\mathbf{v}$ is the change of velocity.
- $\Delta t$ is the elapsed time.
...
1. Shankar, R. *Fundamentals of Physics I*. Yale University Press, 2019. §1.3 — $a(t)=\dfrac{dv}{dt}=\dfrac{d^{2}x}{dt^{2}}$.
2. Knight, R. D. *Physics for Scientists and Engineers: A Strategic Approach with Modern Physics*. Pearson, 2023. §1.5, §2.4 — average and instantaneous acceleration.
