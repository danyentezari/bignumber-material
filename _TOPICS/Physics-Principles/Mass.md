...
1. Knight, R. D. *Physics for Scientists and Engineers: A Strategic Approach with Modern Physics*. Pearson, 2023. — inertia; intrinsic scalar.
2. Carroll, S. M. *Spacetime and Geometry*. Cambridge University Press, 2019. — invariance; curvature source.
3. Susskind, L., & Friedman, A. *Special Relativity and Classical Field Theory: The Theoretical Minimum*. Basic Books, 2017. — rest energy.
4. Shankar, R. *Fundamentals of Physics I*. Yale University Press, 2019. — equivalence of inertial and gravitational mass.
5. Feynman, R. P., Leighton, R. B., & Sands, M. *The Feynman Lectures on Physics*. — center of mass; massless photons.
